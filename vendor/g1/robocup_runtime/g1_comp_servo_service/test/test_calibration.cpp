...
int main(int argc, char** argv)
{
    ...
    // configuration file may reside in project config directory; binary executed from build/
    std::string env_cfg_path = "../config/config.yaml";
    if (argc > 1) {
    ...
    yamlParam_.WriteToYaml("has_calibrate",1);
    yamlParam_.SaveToFile();  // 保存到同一个文件
